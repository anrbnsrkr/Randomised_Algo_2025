...
public:
    ...
    HashTable2Level<int> lis(arr.size());
    for (auto i : arr)
        lis.insert(i);
    ...
    cout << lis.is_present(20) << endl;
    lis.display();
    HashTable2Level<int> *lis2 = new HashTable2Level<int>(11);
    for (auto i : arr)
        lis2->insert(i);
    delete lis2;
    cout<<"Number of trials : "<<trial[0]<<endl;
    cout<<"Iteration, number of element product: : "<<trial[1]<<endl;
    cout<<"Total extra space : "<<trial[2]<<endl;
    return 0;
}
